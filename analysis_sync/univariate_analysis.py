...
#This Strategy analyze the numerical feature by plotting their distribution

class NumericalUnivariateAnalysis(UnivariateAnalysisStrategy):
    def analyze(self, df:pd.DataFrame, feature:str):
        # return super().analyze(df, feature)()
        """
...
#Concrete Strategy for Categorical Data

#This strategy analyze categorical feature by plotting their frequency distribution
